...
date: 2024-08-13
description: 'A guide to creating polished presentation slides using Quarto and Reveal.js with custom CSS.'
---
...
The slides are written using [Quarto](https://quarto.org/), a _flavor_
...
> [!TIP] <span class="dim-text">🏃‍♂️ Follow Along…</span>
>
...
2.  Hunt down the GitHub repo from my _last_ talk and[^2]:
...
<summary>Expand for <code>yaml</code></summary>
...
- Starting with the title slide[^5]:
    ...
    <img src="/posts/dope-slides/assets/title-slide.png" style="width:66.0%" />
    ...
    - The full slide contents are included below:
        ...
        <summary>Expand for <code>quarto</code></summary>
...
<img src="/posts/dope-slides/assets/overview.png" style="width:60.0%" />
...
<summary>Expand for <code>css</code></summary>

<div id="fig-css">

<img src="/posts/dope-slides/assets/css.png" style="width:80.0%" />
...
<img src="/posts/dope-slides/assets/github-pages.png" style="width:80.0%" />
...
> [!TIP] <span style="color: #FF5252;">❤️‍🩹 Status</span>
>
> ```text
