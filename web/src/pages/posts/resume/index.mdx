...
1.  [GLANCED-IO: Taming I/O Optimization for Deep Learning at
    Scale](https://doi.org/10.1145/3806645.3807588) (Sinurat et al.
    (2026))
2.  [Extending µP: Spectral Conditions for Feature Learning Across
    Optimizers](https://arxiv.org/abs/2602.20937) (Gupta et al. (2026))
3.  [Building an AI-native Research Ecosystem for Experimental Particle
    Physics: A Community
    Vision](https://arxiv.org/abs/2602.17582) (Aarrestad et al. (2026))
...
6.  [HiPerRAG: High-Performance Retrieval Augmented Generation for
    ...
    al. (2025))
7.  [Automated Tuning for HMC Mass
...
11. [Thorough Characterization and Analysis of Large Transformer Model
    ...
    (2024))
12. [MLMC: Machine Learning Monte Carlo for Lattice Gauge
...
15. [Comprehensive Performance Study of LLMs on Novel AI
...
23. [Machine Learning and Neural Networks for Field
    Theory](https://bit.ly/snowmass_ml2020) (Foreman et al. (2020))
24. [Examples of renormalization group transformations for image
    sets](https://journals.aps.org/pre/abstract/10.1103/PhysRevE.98.052129)
    (Samuel Foreman et al. (2018))
25. [RG inspired Machine Learning for lattice field
...
27. [Superconductivity of In and Sn
