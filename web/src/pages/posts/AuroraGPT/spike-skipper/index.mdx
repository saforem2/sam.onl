...
date: 2024-09-17
description: 'Implementation of a mechanism to skip bad-data training steps that cause loss spikes during LLM training.'
---
...
![spike-skipper](/posts/auroragpt/spike-skipper/assets/spike-skipper.png)
...
- First 4 steps:
  ...
  <summary><code>tokens</code>:</summary>
