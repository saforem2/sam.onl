...
date: 2025-09-22
description: 'Draft annual report covering scientific accomplishments, publications, presentations, and goals at ALCF.'
draft: true
---
...
1.  [**AERIS**: _Argonne Earth Systems Model for Reliable and Skillful
    Predictions_](https://arxiv.org/abs/2509.13523) (Hatanpää et al.
    (2025))[^1]
...
5.  [MOFA: Discovering Materials for Carbon Capture with a GenAI and
    ...
    al. (2025))
6.  [**MProt-DPO**: _Breaking the ExaFLOPS Barrier for Multimodal
    Protein Design with
    DPO_](https://doi.org/10.1109/SC41406.2024.00013) (Dharuman et al.
    (2024))[^2]
