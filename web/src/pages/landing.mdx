...
<div id="flex-container" style="display: flex; flex-direction: row; gap: 1rem; width: 100%; justify-content: space-between">

<div style="width: round(55%, 1ch);">
