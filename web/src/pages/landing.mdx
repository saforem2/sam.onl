...
<p>I’m a [Computational Scientist][Argonne National Laboratory] in the [AI
/ ML group] at the [Argonne Leadership Computing Facility (ALCF)].</p>

<p>I’m generally interested in the large scale distributed training of AI
models for scientific applications, and am the co-lead of the [Models /
Pre-Training group] for the [AuroraGPT] project.</p>
