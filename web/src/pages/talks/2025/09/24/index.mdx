...
<img src="/talks/2025/09/24/assets/zero.png" style="width:70.0%" />
...
![](/talks/2025/09/24/assets/mprot-3p5B-scaling-2.svg)
...
<img src="../../.././talks/2025/09/24/assets/aeris/aeris-scaling.svg" id="fig-aeris-scaling" />
...
- <span class="highlight-green">**10 EFLOPs**</span> (sustained) @ **120,960
  GPUs**
...
2.  Launch _any_ python _from_ python
    - Launch a module:
...
[^1]:
    Can be skipped if you already have an environment with `torch` +
    `mpi4py`
