...
- [Large Language Models](#large-language-models)
    ...
    - [Life-Cycle of the LLM: Fine-Tuning](#life-cycle-of-the-llm-fine-tuning)
...
- 🏡 [samforeman.me](https://samforeman.me):
    ...
    - 📦 [Repos](https://github.com/saforem2/):
        - [🍋 `saforem2/ezpz`](https://github.com/saforem2/ezpz)
            <span class="dim-text">
                Train your model across any number of arbitrary devices, ezpz.
            </span>
        ...
        - [🏎️
          `argonne-lcf/Megatron-DeepSpeed`](https://github.com/argonne-lcf/Megatron-DeepSpeed)
            <span class="dim-text">
                For only the largest of large language models.
            </span>
...
<img src="/talks/llms-at-scale/assets/collective-allreduce-sum.drawio.svg" style="width:50.0%" />
...
<img src="/talks/llms-at-scale/assets/collective-reduce-sum.drawio.svg" style="width:50.0%" />
...
- `broadcast` (_send_) a tensor <code>$x$</code> from one rank to all
  ranks

<div id="fig-broadcast">

<img src="/talks/llms-at-scale/assets/collective-broadcast.drawio.svg" style="width:50.0%" />
...
<img src="/talks/llms-at-scale/assets/collective-allgather.drawio.svg" style="width:50.0%" />
...
<img src="/talks/llms-at-scale/assets/collective-scatter.drawio.svg" style="width:50.0%" />
...
<span class="dim-text" style="font-size: 0.8em;">
    Modern parallelism techniques[^2] enable the training of large language
    models
</span>
...
Figure 10: **Pre-training**: Virtually _all of the compute_ used during
pre-training
...
<span
    ...
    ![](https://github.com/saforem2/LLM-tutorial/blob/main/docs/assets/jailbreak.jpeg?raw=true)
</span>
...
<script
    ...
    async="true"
    height="600px"
    style="max-height: 600px!important;"></script>
...
[^4]:
    idk why it doesn’t render correctly in the slide (seems like
    refreshing helps?)
