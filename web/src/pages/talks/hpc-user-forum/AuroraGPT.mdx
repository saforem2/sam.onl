...
<div box-="round" style="--box-border-color: var(--blue); margin-bottom: 0.5em;">
...
<column style="width:75%; text-align: center;">

![](https://github.com/Hannibal046/Awesome-LLM/raw/main/resources/image8.gif)

<span style="color: var(--foreground2); font-size: 75%;">
    Image from
...
<img
    src="/talks/hpc-user-forum/assets/timelines.png"
...
![](/talks/hpc-user-forum/assets/AuroraGPT.svg)
...
![](/talks/hpc-user-forum/assets/aurora.png)
...
<div box-="round" style="--box-border-color: var(--red); color: var(--red); font-size:90%;">
...
![](/talks/hpc-user-forum/assets/sambanova.jpeg)
...
![](/talks/hpc-user-forum/assets/graphcore.png)
...
![](/talks/hpc-user-forum/assets/cerebras.jpeg)
...
![](/talks/hpc-user-forum/assets/groq.jpeg)
...
<img
    src="/talks/hpc-user-forum/assets/team/rick-stevens.png"
    style="height:75pt"
    alt="Rick Stevens"
/>

<img src="/talks/hpc-user-forum/assets/team/ian-foster.png" style="height:75pt" alt="Ian Foster" />

<img
    src="/talks/hpc-user-forum/assets/team/rinku-gupta.png"
    style="height:75pt"
    alt="Rinku Gupta"
/>

<img src="/talks/hpc-user-forum/assets/team/mike-papka.png" style="height:75pt" alt="Mike Papka" />

<img
    src="/talks/hpc-user-forum/assets/team/arvind-ramanathan.png"
    style="height:75pt"
    alt="Arvind Ramanathan"
/>

<img
    src="/talks/hpc-user-forum/assets/team/fangfang-xia.png"
    style="height:75pt"
    alt="Fangfang Xia"
/>
...
<img
    src="/talks/hpc-user-forum/assets/team/robert-underwood.png"
    style="height:75pt"
...
<img
    src="/talks/hpc-user-forum/assets/team/venkat-vishwanath.png"
    style="height:75pt"
    alt="Venkat Vishwanath"
/>

<img
    src="/talks/hpc-user-forum/assets/team/sam-foreman.png"
    style="height:75pt"
    alt="Sam Foreman"
/>
...
<img
    src="/talks/hpc-user-forum/assets/team/franck-cappello.png"
    style="height:76pt"
    alt="Franck Cappello"
/>

<img
    src="/talks/hpc-user-forum/assets/team/sandeep-madireddy.png"
    style="height:75pt"
    alt="Sandeep Madireddy"
/>

<img src="/talks/hpc-user-forum/assets/team/bo-li.png" style="height:75pt" alt="Bo Li" />
...
<img
    src="/talks/hpc-user-forum/assets/team/eliu-huerta.png"
    style="height:75pt"
    alt="Eliu Huerta"
/>

<img
    src="/talks/hpc-user-forum/assets/team/azton-wells.png"
    style="height:75pt"
    alt="Azton Wells"
/>
...
<img
    src="/talks/hpc-user-forum/assets/team/rajeev-thakur.png"
    style="height:75pt"
    alt="Rajeev Thakur"
/>
...
<img
    src="/talks/hpc-user-forum/assets/team/charlie-catlett.png"
    style="height:75pt"
    alt="Charlie Catlett"
/>

<img
    src="/talks/hpc-user-forum/assets/team/david-martin.png"
    style="height:75pt"
    alt="David Martin"
/>
...
<img
    src="/talks/hpc-user-forum/assets/team/brad-ullrich.png"
    style="height:75pt"
    alt="Brad Ullrich"
/>
...
<column style="background: oklch(from #03BD00 calc(l * 1.15) c h / 0.1); border: 1px solid #03BD00; border-radius: 0.25em; padding: 3pt 8pt; margin-left: 5pt; margin-right: 5pt;">
...
<column style="background: oklch(from #E90102 calc(l * 1.15) c h / 0.1); border: 1px solid #E90102; border-radius: 0.25em; padding: 3pt 8pt; margin-left: 5pt; margin-right: 5pt;">
...
- To train a fixed model on trillions of tokens requires:
    - Aggregating data from multiple different _corpora_ (e.g. Reddit,
      StackExchange, GitHub, etc.)
    - Sampling _each training batch_ according to a fixed distribution
      across corpora
...
- [x] Completely re-wrote an asynchronous, distributed implementation
      that _significantly_ improves performance
...
![Time spent building `BlendableDataset`](/talks/hpc-user-forum/assets/blendable.svg)

</column>

<column>

![Time spent building `GPTDataset`](/talks/hpc-user-forum/assets/gpt.svg)
...
- [🏎️
  `argonne-lcf/Megatron-DeepSpeed`](https://github.com/argonne-lcf/Megatron-DeepSpeed)
    <span style="color: var(--foreground2)">For the largest of large language models.</span>
- [🍋 `saforem2/ezpz`](https://github.com/saforem2/ezpz)
    <span style="color: var(--foreground2)">Distributed training, ezpz.</span>
- 👀 See also:
...
<img src=".././talks/hpc-user-forum/assets/anl.svg" style="height:50pt;" />

<span style="color: var(--foreground2); font-size: 2.0em;"></span>

<img src=".././talks/hpc-user-forum/assets/deepspeed-logo-transparent.svg" style="height:50pt;" />
