...
<figure>
    <picture>
        ...
        <img
            ...
            alt="Two panels for AuroraGPT-20B: left, pretraining loss falling from 12.9 to 5.2 over ~1,700 steps; right, final lm-eval scores (HellaSwag 0.61, ARC-Easy 0.65, ARC-Challenge 0.36, Winogrande 0.58, PIQA 0.76, BoolQ 0.58) all above their random baselines."
        />
    </picture>
</figure>
...
Left panel: pretraining loss falls from 12.9 at init to about 5.2. Right panel:
