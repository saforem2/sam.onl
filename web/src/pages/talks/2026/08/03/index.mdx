...
layer on top. Never pip-install into base: it is read-only and you will want it
...
silently mix ABIs. Clone base only if some package truly requires conda: cloning
