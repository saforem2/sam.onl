...
<figure>
    <img
        src="/talks/2026-07-14/figures/lr-finder-80b-adamw-vs-mano.png"
        alt="80B LR-finder at GBS=6144 on Sunspot: AdamW vs mano loss-vs-LR, showing the hard NaN cliff"
    />
    <figcaption>
        80B LR-finder (GBS=6,144, Sunspot): AdamW hits a **hard NaN cliff**
        (usable ~7.4e-7, no clean minimum); `mano` tolerates a wider band but
        still isn't production-safe as a constant LR. Data:
