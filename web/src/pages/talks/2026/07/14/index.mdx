...
<style>{`
  ...
  #since-tpc table th:nth-child(1), #since-tpc table td:nth-child(1) { width: 12ch; white-space: nowrap; } /* Run */
...
<style>{`
  ...
  #mano .mano-right img { width: 100%; height: auto; max-height: 46lh; }
  #mano table { max-width: none; }
