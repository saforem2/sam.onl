...
| **2B** CPT   |   256 |  5,960 | ~300B pilot     | 2.49 | dolmino sweep beats olmo  |
...
- These slides: [samf.sh/talks/2026/06/03](https://samf.sh/talks/2026/06/03)
...
<figure>
    {/* TODO figure: 80B loss under the stable TP=4/GBS=372 corner
       (12.93 -> 7.72 over 100 steps) vs the NaN'd runs. Data:
       docs/production/agpt/80b/README.md. Drop an SVG at
       /talks/2026-07-14/figures/loss-80b-corner.svg and swap this. */}
    <figcaption>
        Data:
        [`docs/production/agpt/80b`](https://github.com/saforem2/torchtitan/tree/ezpz/torchtitan/experiments/ezpz/docs/production/agpt/80b)
    </figcaption>
</figure>
