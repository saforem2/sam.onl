...
The same Aurora + `ezpz`/`torchtitan` stack also trained
**AERIS**[^aeris], a pixel-level Swin **diffusion transformer** for
...
- Same lessons carried over: launcher-native scaling, bf16 stability care,
  and failure-tolerant runs at 10k-node scale.
- The hard new problem was **scaling diffusion stably at high resolution**,
