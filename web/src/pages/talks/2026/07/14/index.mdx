...
<style>{`
  ...
  /* LR on wide, TB on narrow (see posttrain-intro for the mechanism). */
  #fork-tax .ft-mobile { display: none; }
  @media (max-width: 768px) {
    #fork-tax .ft-desktop { display: none; }
    #fork-tax .ft-mobile { display: block; }
  }
...
{/*───────────────────────────────────────────────────────────────
Appendix: alternative optimizers — mano (the 2B-scale win)
───────────────────────────────────────────────────────────────*/}
