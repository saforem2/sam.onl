...
<style>{`
  /* Pin every column so the narrow numeric fields (Nodes/Steps/Loss) don't
     hog the row while Status wraps. Fixed-layout table splits leftover width
     evenly across unset columns, which is why the numerics ballooned. */
  #since-tpc table th:nth-child(1), #since-tpc table td:nth-child(1) { width: 11ch; } /* Run */
  ...
  #since-tpc table th:nth-child(5), #since-tpc table td:nth-child(5) { width: 7ch; }  /* Loss */
  #since-tpc table th:nth-child(6), #since-tpc table td:nth-child(6) { width: auto; } /* Status */
...
<style>{`
  ...
  #optimizer-cliff table th:nth-child(1), #optimizer-cliff table td:nth-child(1) { width: 12ch; } /* Optimizer */
  #optimizer-cliff table th:nth-child(2), #optimizer-cliff table td:nth-child(2) { width: 9ch; }  /* Died at */
  #optimizer-cliff table th:nth-child(3), #optimizer-cliff table td:nth-child(3) { width: auto; } /* Signature */
`}</style>
