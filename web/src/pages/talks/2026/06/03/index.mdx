...
By mid-2026 the calculus changed: `torchtitan` + DTensor + FSDP2 closed the gap
...
<figure>
    <picture>
        <source media="(max-width: 768px)"
                srcset="/talks/2026-06-03/figures/lr-finder-sunspot-mobile.svg" />
        <img src="/talks/2026-06-03/figures/lr-finder-sunspot.svg"
             alt="LR-vs-loss sweeps for AdamW, Muon, SophiaG across 2B/20B/80B configs on Sunspot" />
    </picture>
    <figcaption>
        Cross-optimizer sweep on Sunspot (Intel Max 1550). Full report:
