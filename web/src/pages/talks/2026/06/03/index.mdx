...
## 2B reference — train + val loss

<figure>
    <img
        style="width:100%;"
        src="/talks/2026-06-03/figures/2b-mds/light/train_val_loss_vs_iter.svg"
        alt="AuroraGPT-2B train + val loss vs iteration"
        class="figure-light"
    />
    <img
        style="width:100%;"
        src="/talks/2026-06-03/figures/2b-mds/dark/train_val_loss_vs_iter.svg"
        alt="AuroraGPT-2B train + val loss vs iteration"
        class="figure-dark"
    />
    <figcaption>
...
{/*───────────────────────────────────────────────────────────────
2B eval comparison — MDS vs TT (and the bug)
───────────────────────────────────────────────────────────────*/}
...
<figure>
    <img
        ...
        alt="2B eval comparison: MDS vs TT v1 vs TT v2"
    />
    <figcaption>
        MDS (SophiaG): full trajectory, 7.77T tokens · TT v1 (bf16-master):
        18K steps, flat at random — the bug · TT v2 (fp32-master, 512N): 13
        checkpoints, 1.31T tokens — +13.9pp HellaSwag / +33.3pp ARC-Easy
        over v1 at matched token budget
    </figcaption>
</figure>
