...
<div class="flex-container icon-flex" style="flex-direction: row; gap: 1ch; margin-block-end: 0.5lh; justify-content: space-between;margin-inline-end: 4px; line-height: 1.33;">
