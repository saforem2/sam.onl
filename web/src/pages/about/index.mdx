...
.recent-posts-table {
    /* width: fit-content sized the table to content's max-content,
       ...
       the first row's widths and let the Title cell wrap. */
    width: 100%;
    max-width: 100%;
    table-layout: fixed;
    border-collapse: collapse;
...
/* Title cell: take the remaining width and wrap inside it. */
