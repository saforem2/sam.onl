...
def _load_chains():
    ...
    return (mds, mds_tokens, tt2b_256, tt2b_256_tokens,
            tt2b_512, tt2b_512_tokens, tt20b_512, tt20b_512_tokens)
...
def _draw_lines(ax, task: str, baseline: float, i: int, chains):
    (mds, mds_tokens, tt2b_256, tt2b_256_tokens,
     tt2b_512, tt2b_512_tokens, tt20b_512, tt20b_512_tokens) = chains
